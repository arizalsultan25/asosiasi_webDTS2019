            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <img src="../img/id-card.png" alt="icon id card" style="height:200px; margin-left:4%; margin-top: 2%">
                        <div style="float:right; margin-right:24%">
                            <table border=0>
                                <tr>
                                    <td width=250>
                                        <h3 class="font-weight-light"> NIK </h3>
                                    </td>
                                    <td width=15>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['nik']; ?> </h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h3 class="font-weight-light"> Nama </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['nama']; ?> </h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h3 class="font-weight-light"> Tanggal Lahir </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['ttl']; ?> </h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h3 class="font-weight-light"> Alamat </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['alamat']; ?> </h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h3 class="font-weight-light"> Provinsi </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['provinsi']; ?> </h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <h3 class="font-weight-light"> E-mail </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> : </h3>
                                    </td>
                                    <td>
                                        <h3 class="font-weight-light"> <?php echo $data['email']; ?> </h3>
                                    </td>
                                </tr>
                            </table>
                        </div>
