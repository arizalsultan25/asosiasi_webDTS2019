...
<head>
  ...
  <title>Admin - Data Otoritas</title>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Otoritas</li>
        </ol>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Data Otoritas</div>
          <div class="card-body">
          <a href="tambah_otoritas.php" class="btn btn-outline-info"
          style="margin-bottom:30px; width:15%; margin-left:40%"><i class="fas fa-plus"></i> Tambah Data </a>
          <table id="example" class="table table-striped table-bordered" style="width:100%; margin-top:45px">
          <thead>
          <tr>
      ...
      <?php
            ...
            mapping_pengguna where id_posisi <> 4 and id_posisi <> 1)");
            $no = 1;
            while($data = mysqli_fetch_array($data_anggota)){ 
                  $nomor = $data['nik'];
                  $data_status = mysqli_query($conn, "select * FROM posisi where id_posisi = 
                  (select id_posisi from mapping_pengguna where nik='$nomor')");
